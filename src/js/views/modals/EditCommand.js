			...
			<Modal className="modal--create-command">
				...
				<form onSubmit={(e) => this.handleSubmit(e)}>
					...
					<div className="field text white">
						...
						<div className="input">
							<div className="commands__item commands__item--large">
								<Icon className="commands__item__icon" name={this.state.icon} />
								<div className={"commands__item__background "+this.state.colour+"-background"}></div>
							</div>
						</div>
					</div>
